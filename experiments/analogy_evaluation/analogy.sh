...
python ../../glove-python/examples/analogy_tasks_evaluation.py --test ../../glove-python/examples/questions-words.txt --model imported_new_$fbname.model --parallelism 10 | tee -a modified_analogy_report
